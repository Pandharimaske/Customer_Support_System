...
class DataIngestion:
    ...
    def __init__(self):
        """
        Initialize environment variables, embedding model, and setCSV file path.
        """
    ...
    def transform_data(self):
        ...
        for _ , row in self.product_data.iterrows():
            ...
            produuct_list.append(product_entry)

        docuemnts = []
        for entry in produuct_list:
            metadata = {
            ...
            docuemnts.append(doc)

        print(f"Transformed {len(docuemnts)} documents.")
        return docuemnts
    ...
    def store_in_vector_db(self , documents: List[Document]):
        ...
        print(f"Successfully insertd {len(inserted_ids)} documents into AstraDB.")
    ...
    def run_pipeline(self):
        ...
        vstore , inserted_ids = self.store_in_vector_db(documents=documents)
